<script lang="ts">
  ...
  async function handleDelete() {
    ...
    try {
      await deleteHistoryItem('history', deleteUrl);
                  ...
                  <div class="flex flex-1 flex-col gap-1">
                    <div class="flex items-start justify-between gap-2">
                      ...
                      <Button
                        variant="ghost"
                        size="icon-sm"
                        class="opacity-0 cursor-pointer transition-opacity group-hover:opacity-100 hover:bg-destructive/10 hover:text-destructive"
                        onclick={() => {
